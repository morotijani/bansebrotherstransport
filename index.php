          ...
          <!-- Nav item link-->
			...
			<div class="navbar-collapse collapse" id="navbarCategoryCollapse">
				<ul class="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
					...
					<!-- Nav item Cabs -->
					<li class="nav-item"> <a class="nav-link active" href="index-cab.html"><i class="fa-solid fa-car me-2"></i>Cab</a></li>
				</ul>
			</div>
					...
					<div class="row position-relative p-sm-3">
						...
						<div class="col-lg-7">
							...
							<div class="hstack gap-3">
								...
								<a href="#"> <img src="assets/images/element/google-play.svg" class="h-50px" alt=""> </a>
								<!-- App store button -->
								<a href="#"> <img src="assets/images/element/app-store.svg" class="h-50px" alt=""> </a>
							</div>
						</div>
						<!-- Content START -->
					</div>
